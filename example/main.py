...
class Container(FloatLayout):
	...
	def __init__(self):
		...
		FloatLayout.__init__(self, size=Window.size)
		...
		if len(self.pictures) != 0:
			...
			with self.grid_layout.canvas.before:
				Color(1,1,1,1)
				Rectangle(pos=self.grid_layout.pos, size=(Window.width,self.grid_layout.height))
			...
			self.grid_layout.add_widget(self.pb)
			self.grid_layout.add_widget(self.score_label)
			self.grid_layout.add_widget(self.machine_score_label)
			self.add_widget(self.display)
			self.add_widget(self.grid_layout)
		# Display message if they have finished
		else:
			self.label = TextLabel(text='You have annotated all the data currently available, great work!')
...
class AnnotateScreen(Screen):
	def __init__(self):
		...
		self.grid_layout = GridLayout(
			...
			rows=2,
			size_hint=(1, 0.15),
			padding=(Window.width/15,5),
			spacing=(Window.width/2,0))
		# Create buttons
...
class ExampleScreen(Screen):
	def __init__(self):
		...
		self.good_im = Image(source='C:\\Users\\kvl_user\\PycharmProjects\\anno5i9\\example\\data\\good.png')
		self.unclear_im = Image(source='C:\\Users\\kvl_user\\PycharmProjects\\anno5i9\\example\\data\\unclear.png')
		self.bad_im = Image(source='C:\\Users\\kvl_user\\PycharmProjects\\anno5i9\\example\\data\\bad.png')

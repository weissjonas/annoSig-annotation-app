...
class Container(BoxLayout):
    ...
    def on_touch_up(self, touch):
        ...
        try:
            ...
            return
        # Check if there are still pictures to be annotated
        if len(self.pictures) != 0:
            ...
            if dist > min_dist and dx > Window.width / 5:
                ...
                # Display message based on the accuracy of the user score
                if self.ranking < 0.1:
    ...
    def change_image(self, score=None):
        ...
        # Check if there are any pictures left to be annotated
        if len(self.pictures) == 0:
            self.clear_widgets()
...
class MenuScreen(Screen):
    def __init__(self):
        ...
        # Game Title
        self.title = Label(text="Fetal ECG Annotation Game", color=(0, 0, 128, 1), size_hint_y=0.4,
                           font_size=Window.height / 20, bold=True, font_name='Helvetica')
